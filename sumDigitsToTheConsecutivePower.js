...
in the title of this kata. What's the use of saying "Eureka"? 
...
[a, b] (inclusive) and outputs a list of the sorted numbers in 
...
function sumDigPow(a, b) {
    ...
    for(let i = a; i < b; i+=1){
      ...
      let squared = num.reduce((a, b, i)=> a + parseInt(b)**(i+1), 0)
      if(squared === parseInt(num.join(''))){
        result.push(squared)
      }
    }
    return result
