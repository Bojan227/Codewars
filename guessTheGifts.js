...
function guessGifts(wishlist, presents) {
    ...
    while (currentItemCount < wishlist.length) {
      let currentItem = wishlist[currentItemCount];
      presents.forEach((items) => {
        if (
          items.size === currentItem.size &&
          items.clatters === currentItem.clatters &&
          items.weight === currentItem.weight
        ) {
