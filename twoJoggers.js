...
They both start at the same spot called "Start" and they each run a 
different lap, which may (or may not) vary in length. Since they know 
...
has to complete before they meet each other again, at the same time, at the 
start.
...
The function should return an array (Tuple<int, int> in C#) containing 
exactly two numbers:
