...
function isLanguageDiverse(list) {
   ...
   const occurences = list.reduce((acc, curr)=>{
    ...
    const toArray = Object.values(occurences).sort((a,b)=>a-b)
    const filtered = toArray.filter(val=>toArray[0] * 2 >= val)
    console.log(filtered)
    return filtered.length !== 3 ? false : true
